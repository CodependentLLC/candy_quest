...
document.querySelector("#result-map")?.addEventListener("click",()=>{ game.resultMode=null; game.completed=false; game.gameOver=false; game.updateResultOverlay(); game.openMap(); map.show(); });
